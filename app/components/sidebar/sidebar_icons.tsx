...
function PropertyListingsIcon() {
  return (
    <svg className="h-5 w-5" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
      <path d="M3 12h2m2-7l-2 7m8-7l-2 7m8-7l-2 7M3 20h18a2 2 0 0 0 2-2V9a2 2 0 0 0-2-2H3" strokeLinecap="round" strokeLinejoin="round" />
      <path d="M9 8V5a2 2 0 0 1 2-2h2a2 2 0 0 1 2 2v3M8 20v-3h8v3" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );
}
...
function RentalApplicationIcon() {
  return (
    <svg className="h-5 w-5" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
      ...
      <path d="M9 8h.01" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );
}
...
function LeaseAgreementIcon() {
  return (
    <svg className="h-5 w-5" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
      <path d="M7 21h10a2 2 0 0 0 2-2V9.414a1 1 0 0 0-.293-.707l-5.414-5.414A1 1 0 0 0 13.586 3H7a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2z" strokeLinecap="round" strokeLinejoin="round" />
      <path d="M9 12h6M9 15h4M9 18h3" strokeLinecap="round" strokeLinejoin="round" />
      <path d="M15 9l2 2" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );
}

function StorageRequestsIcon() {
  return (
    <svg className="h-5 w-5" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
      <path d="M4 5h16a1 1 0 0 1 1 1v3h-2V7H5v2H3V6a1 1 0 0 1 1-1z" strokeLinecap="round" strokeLinejoin="round" />
      <path d="M3 10h18v8a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-8z" strokeLinecap="round" strokeLinejoin="round" />
      <path d="M8 14h1M14 14h1" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );
}

function WarehouseListingsIcon() {
  return (
    <svg className="h-5 w-5" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
      <path d="M12 2L2 7v10a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2V7l-10-5z" strokeLinecap="round" strokeLinejoin="round" />
      <path d="M8 11h2v6H8zM14 11h2v6h-2z" strokeLinecap="round" strokeLinejoin="round" />
      <path d="M12 11v6" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );
}

function LogisticsSupportIcon() {
  return (
    <svg className="h-5 w-5" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
      <path d="M5 9l7-7 7 7M5 9v10a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2V9" strokeLinecap="round" strokeLinejoin="round" />
...
function BookingsIcon() {
  return (
    <svg className="h-5 w-5" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
      <path d="M4 10a4 4 0 0 1 4-4h8a4 4 0 0 1 4 4v8a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2v-8z" strokeLinecap="round" strokeLinejoin="round" />
      <path d="M8 6V4h8v2M8 14h8M9 18h6" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );
}
...
function TicketsIcon() {
  return (
    <svg className="h-5 w-5" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
      <path d="M4 9V6a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v3a3 3 0 0 0 0 6v3a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2v-3a3 3 0 0 0 0-6z" strokeLinecap="round" strokeLinejoin="round" />
      <path d="M9 8h.01M9 12h.01M9 16h.01M13 9h4M13 15h4" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );
}
...
function BlogsIcon() {
  return (
    <svg className="h-5 w-5" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
      <path d="M5 4h10a4 4 0 0 1 4 4v12H8a3 3 0 0 1-3-3V4z" strokeLinecap="round" strokeLinejoin="round" />
      <path d="M8 8h7M8 12h7M8 16h4" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );
}
