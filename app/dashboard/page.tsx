      ...
      <div style={{ display: 'flex', alignItems: 'flex-end', justifyContent: 'space-between', gap: 8 }}>
        <div>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 6 }}>
            {stat.delta && (
              <span style={{ display: 'flex', alignItems: 'center', gap: 2, fontSize: 11, fontWeight: 500, color: stat.deltaDir === 'up' ? 'var(--status-success)' : stat.deltaDir === 'down' ? 'var(--status-danger)' : 'var(--text-muted)' }}>
                {stat.deltaDir === 'up' ? <TrendingUp size={12} /> : stat.deltaDir === 'down' ? <TrendingDown size={12} /> : null}
                {stat.delta}
              </span>
            )}
